...
function createProxy() {
  return (req, res, next) => {
    ...
    console.log('Custom proxy handling:', req.method, req.url);
...
app.listen(PORT, () => {
  ...
  console.log('Using custom implementation to avoid path rewriting issues');
});