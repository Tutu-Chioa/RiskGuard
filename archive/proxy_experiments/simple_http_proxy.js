...
app.use('/api', (req, res, next) => {
  console.log('Manual proxy handling:', req.method, req.url);
...
app.listen(PORT, () => {
  console.log('Simple HTTP proxy server running on http://localhost:' + PORT);
  console.log('Proxy to backend API at http://' + BACKEND_HOST + ':' + BACKEND_PORT);
  console.log('All /api requests will be forwarded to backend');
});