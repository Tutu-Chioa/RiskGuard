...
// 为所有以 /api 开头的路径使用代理 - 使用正确的Express 5语法
app.use('/api', (req, res, next) => {
  // 重新构建完整路径
  const fullUrl = req.baseUrl + req.path;  // 这会给我们 /api/auth/login
  console.log('Full URL:', fullUrl);
  
  // 重新设置req.url以确保它包含完整路径
...
app.listen(PORT, () => {
  ...
  console.log('Using correct Express 5 syntax for route matching');
});